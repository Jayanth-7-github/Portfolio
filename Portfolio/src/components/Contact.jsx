    ...
    <PageWrapper className="flex items-center justify-center relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-4xl px-6 py-12 flex flex-col items-center">
        <motion.div
          ...
          className="w-full max-w-lg bg-slate-900/80 border border-white/10 backdrop-blur-xl rounded-3xl p-8 md:p-12 shadow-2xl relative overflow-hidden group"
        >
          ...
          <div className="relative z-10 text-center">
            ...
            <div className="space-y-6 text-left">
              <a
                ...
                className="flex items-center gap-4 p-4 rounded-2xl bg-slate-900/80 border border-white/5 hover:bg-slate-800 hover:border-white/10 transition group/item"
              >
